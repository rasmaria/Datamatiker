...
public class Hilsen {
   ...
   /* public static void main(String[] args) {
        Basic.Hilsen hejNy = new Basic.Hilsen();
        String name = "Julie";

        hejNy.hej(name);

        System.out.println(hejNy.hej(name));


    }

    public Basic.Hilsen(String name)
    ...
    */
    ...
    public static void main(String[] args) {
        Hilsen hejNy = new Hilsen("Maria");
        System.out.println(hejNy.hej());
