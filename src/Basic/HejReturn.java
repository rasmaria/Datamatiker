...
public class HejReturn {

    public static void main(String[] args) {
        System.out.println(hejReturn("Mikkel"));
        System.out.println(hejReturn("Makkel"));
        System.out.println(hejReturn("Mukkel"));

    }

    public static String hejReturn(String nameReturn) {
        return("Hej " + nameReturn + "! :-)))))");
...
//Prøv nu at kalde metoden hej inde fra main-metoden. Husk at give den en variabel af typen String med som argument. Det kan fx være navnet ”Poul”.
//Idet main-metoden og vores hej-metode befinder sig i samme klasse kan vi bare uden videre kalde hej-metoden inde fra main, fx med statementet hej(”Bo”).
// NB: Husk at man ellers i de tilfælde hvor metoderne ikke er defineret i samme klasse kalder statiske metoder på klassen,
// dvs. klassenavnet som står med stort bogstav, dot-operatoren (altså et punktum), og så metodens navn. Under alle omstændigheder skal der altså IKKE laves et nyt objekt af typen Basic.Hilsen, for at kunne kalde metoden hej.
